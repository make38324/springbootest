...
//        matcher.reset();
    ...
    public void download(String jsurl,String fileout) {
        try {
    ...
    public void testcase() {
        //下载js
        download("http://echarts.baidu.com/gallery/vendors/echarts/map/js/china.js","file/temp.js");


//        String oneHtml = null;
//        try {
//            oneHtml = getOneHtml("http://echarts.baidu.com/gallery/vendors/echarts/map/js/china.js");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        sysout(oneHtml);
